  ...
  <div className="w-full max-w-[424px] bg-white rounded shadow-md">
    ...
    <div className="flex flex-col gap-6 items-center px-4">
      <div className="relative w-full">
         <Image src={"/user.png"} alt="" height={24} width={24} className="absolute left-4 top-3" /> 
        <input type="text" placeholder="Name" className="w-full h-[44px] border-2 rounded px-12" />
      </div>
      <div className="relative w-full">
         <Image src={"/enevelop.png"} alt="" height={24} width={24} className="absolute left-4 top-3" /> 
    ...
    <div className="flex justify-center px-4 mb-6 ">
      <Link href={"/signin"} className="w-full text-center p-2 max-w-[360px] h-[44px] bg-[#FF9F0D] text-white rounded">Sign Up</Link>
    </div>
    ...
    <div className="flex flex-col gap-6 items-center px-4 mb-10">
      ...
      <div className="relative w-full">
        <Image src={"/apple.png"} alt="" height={24} width={24} className="absolute left-4 top-3" />

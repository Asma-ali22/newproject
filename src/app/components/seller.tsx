...
const Seller = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 lg:px-28 py-8">
      <h1 className="text-xl sm:text-2xl font-bold mb-6 text-center text-gray-600">Featured Product</h1>
      <h2 className="text-2xl sm:text-4xl font-bold mb-6 text-center">Bestseller Products</h2>
      <p className="text-base sm:text-xl font-medium mb-6 text-center text-gray-600">
